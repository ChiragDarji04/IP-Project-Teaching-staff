...
<body>
    ...
    <nav id="navbar" class="navbar smart-scroll navbar-expand-lg navbar-info">
        <a class="navbar-brand mr-auto" href="#"><img src="logo12.png" height="55px" width="55px"></a>
        ...
        <div class="collapse navbar-collapse" id="main_nav">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="#personalinformation"><i class="fa fa-home"></i> Home <span
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" target="_blank"
                            href="https://scholar.google.com/scholar?hl=en&as_sdt=0%2C5&q=yogesh+pingle&btnG=&oq=yogesh+">Google
                            Scholor</a>
                        <a class="dropdown-item" target="_blank"
                            href="https://www.scopus.com/authid/detail.uri?authorId=57170579400">Scopus</a>
                ...
                <div class=" container d-flex justify-content-center">
                    <div class="row">
                        <div class="ypimg col-12 col-sm-6 align-self-center">
                            <img id="profile-card" src="pic.jpg">
                        </div>
                ...
                <ul>
                    <li>
                        <p>Teaching German Language of A1 Certification level at a professional level in the College .
                            <span><a href="docs/german.jpg" target="_blank"
                                    class="btn btn-outline-info btn-sm">View</a></span>
                        </p>
                    ...
                    <li>
                        <p>Opted German Language in school and Cleared G2 Course from Max Mueller Bhavan, Pune .
                            <span><a href="docs/german2.jpg" target="_blank"
                                    class="btn btn-outline-info btn-sm">View</a><span>
                        </p>
                ...
                <ul>
                    <li>
                        <p>Selected as a Session Chairperson on Special Theme IOT
                            ...
                            <a href="http://www.bvicam.ac.in/indiacom/splSessionDetails.asp?sessionRequestID=1087"
...
?>
            ...
            <div class="col-12 col-sm-4" id="accordion">
                <div class="card">
                    <div id="books" class="card-header" id="headingOne">
                        <h5 class="mb-0">
                            <button class="collapse-btn btn btn-link collapsed" data-toggle="collapse"
    ...
    <div style="padding-top: 10px;" id="pubincon" class=" heading container ">
        <div class="row row-content">
            <div class="col-12 col-sm-12">
                <h6> <a class="" data-toggle="collapse" href="#collapseExample2" aria-expanded="false"
    ...
    <div style="padding-top: 10px;" id="pubinjou" class=" heading container ">
        <div class="row row-content">
            <div class="col-12 col-sm-12">
                <h6> <a class="" data-toggle="collapse" href="#collapseExample3" aria-expanded="false"
    ...
    <div style="padding-top: 10px;" class=" heading container ">
        <div class="row row-content">
            <div class="col-12 col-sm-12">
                <h6> <a class="" data-toggle="collapse" href="#collapseExample4" aria-expanded="false"
    ...
    <div style="padding-top: 10px;" id="training" class=" heading container ">
        <div class="row row-content">
            <div class="col-12 col-sm-12">
                <h6> <a class="" data-toggle="collapse" href="#collapseExample11" aria-expanded="false"
    ...
    <div style="padding-top: 10px;" class=" heading container ">
        <div class="row row-content">
            <div class="col-12 col-sm-12">
                <h6> <a class="" data-toggle="collapse" href="#collapseExample5" aria-expanded="false"
    ...
    <div style="padding-top: 10px;" id="nptel" class=" heading container ">
        <div class="row row-content">
            <div class="col-12 col-sm-12">
                <h6> <a class="" data-toggle="collapse" href="#collapseExample6" aria-expanded="false"
    ...
    <div style="padding-top: 10px;" class=" heading container ">
        <div class="row row-content">
            <div class="col-12 col-sm-12">
                <h6> <a class="" data-toggle="collapse" href="#collapseExample8" aria-expanded="false"
    ...
    <div style="padding-top: 10px;" id="pro" class=" heading container ">
        <div class="row row-content">
            <div class="col-12 col-sm-12">
                <h6> <a class="" data-toggle="collapse" href="#collapseExample7" aria-expanded="false"
    ...
    <div id="youtube" class=" container">
        <div class="  youtube-container row">
            <div class="col-12 col-sm-4">
                <iframe width="100%" src="https://www.youtube.com/embed/BUH5Ykkwidk" frameborder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>
            </div>
            <div class="col-12 col-sm-4">
                <iframe width="100%" src="https://www.youtube.com/embed/Hbff9xvJFI4" frameborder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>
            </div>
            <div class="col-12 col-sm-4">
                <iframe width="100%" src="https://www.youtube.com/embed/20u-qP0hwzQ" frameborder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>
            </div>
        </div>
    ...
    <div id="" class=" container ">
        <div class="row">
            <div class="blog col-12 col-md-4">
                <a target="_blank" href="https://yogeshpingle.home.blog/"><img class="d-block w-100 "
                        src="blog.jpg"></a>
            </div>
            <div class="blog col-12 col-md-4">
                <a target="_blank" href="http://yppingle.blogspot.com/"><img class="d-block w-100 " src="music.png"></a>
            </div>
            <div class="blog col-12 col-md-4">
                <a target="_blank"
                    href="https://scholar.google.com/scholar?hl=en&as_sdt=0%2C5&q=yogesh+pingle&btnG="><img
                        class="d-block w-100 " src="google-scholar.png"></a>
            </div>
        </div>
        <div class="row">
            <div class="scopus col-12 ">
                <a target="_blank" href="https://www.scopus.com/authid/detail.uri?authorId=57170579400"><img
                        class="d-block w-100 " src="scopus.JPG"></a>
            </div>
        </div>
    ...
    <footer class="site-footer">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-4">
                    ...
                    <ul class="footer-links">
                        <li><a target="_blank" href="https://www.scopus.com/authid/detail.uri?authorId=57170579400"><i
                                    class="fas fa-hand-point-right"></i> Scopus</a></li>
                        <li><a target="_blank" href="https://yogeshpingle.home.blog/"><i
                                    class="fas fa-hand-point-right"></i> Blog</a></li>
                        <li><a target="_blank"
                                href="https://scholar.google.com/scholar?hl=en&as_sdt=0%2C5&q=yogesh+pingle&btnG=&oq=yoge"><i
                                    class="fas fa-hand-point-right"></i> Google Scholor</a></li>
                        <li><a target="_blank" href="http://yppingle.blogspot.com/"><i
                                    class="fas fa-hand-point-right"></i> Music Therapy</a></li>
                        <li><a target="_blank" href="https://publons.com/researcher/3762151/yogesh-pingle/"><i
                                    class="fas fa-hand-point-right"></i> Publons</a></li>
                        <li><a target="_blank" href="https://orcid.org/0000-0003-2124-885X"><i
                                    class="fas fa-hand-point-right"></i> Orcid</a></li>
                ...
                <div class="col-xs-6 col-md-4">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a target="_blank" href="https://www.youtube.com/channel/UCjhJz7_GBZO8ru3PdCdILBg"><i
                                    class="fas fa-link"></i> YouTube</a></li>
                ...
                <div class="col-xs-6 col-md-4">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href=""><i class="fa fa-envelope"></i><a href=""> yogeshpingle1977@gmail.com </a>/ <a
                                    href="">yogesh.pingle@vcet.edu.in</a> </a></li>
                    </ul>
                </div>
            </div>
            <hr>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <ul class="social-icons">
                        <li><a class="facebook" target="_blank" href="https://www.facebook.com/yogesh.pingle.92"><i
                                    class="fab fa-facebook"></i></a></li>
                        <li><a class="twitter" target="_blank" href="#"><i class="fab fa-twitter"></i></a></li>
                        <li><a class="dribbble" target="_blank"
                                href="https://www.youtube.com/channel/UCjhJz7_GBZO8ru3PdCdILBg"><i
                                    class="fab fa-youtube"></i></a></li>
                        <li><a class="linkedin" target="_blank"
                                href="https://www.linkedin.com/in/yogesh-pingle-9922743a/"><i
        ...
        <div class="col-xs-12 mt20" id="bg">
            <div style="margin:0px auto;width:133px;background:#443c94;text-align:left;display:flex;border-radius:5px">
                <span style="padding:7px;display:inline-block;border-right:1px solid #746dba"><a
                        href="http://visitorshitcounter.com" rel="nofollow noopener" target="_blank"
                        title="https://visitorshitcounter.com/"><img src="https://visitorshitcounter.com/img/s-logo.svg"
                            alt="https://visitorshitcounter.com/"
                            style="width:100%;border:none;float:left"></a></span><span class="text"
                    id="dupli_hit_counter"
                    style="padding:10px 0 0 0;display:inline-block;color:#ffffff;width:100%;text-align:center;"></span></span><input
                    type="hidden" id="site_val"
                    value="https://visitorshitcounter.com/counterDisplay?code=ddf2e938a6e52a7cfaad6e5a45203ab8&style=0017&pad=5&type=page&initCount=1">
            </div>
        </div>
