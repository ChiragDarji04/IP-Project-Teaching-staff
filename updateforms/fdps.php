                ...
                <div id="" class="container ">
                    ...
                    <form id="form8" method="GET" action="fdps.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="fdps-rollno" class="form-control" value='<?php echo $rollno; ?>'>
                            <input type="text" name="fdps-name" id="fdpsname" class="form-control" value='<?php echo $program; ?>' placeholder="Enter Program Name">
                        </div>
                        <div class="form-group">
