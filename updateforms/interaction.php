...
<body>
        ...
        <div class="row">
            ...
            <div id="div2" class="container1 col-12 col-sm-8">
                ...
                <div id="" class="container ">
                    ...
                    <form id="form3" method="GET" action="interaction.php" enctype="multipart/form-data">
                        <br>
                        <h3>INTERACTION WITH OUTSIDE WORLD</h3>
                        <hr>
                        <div class="form-group">
                            <label for="formGroupinteractionInput">NATURE OF INTERACTION</label>
                            <input type="hidden" name="interaction-rollno" class="form-control" value='<?php echo $rollno; ?>'>
                            <input type="text" name="interaction" class="form-control" id="formGroupinteractionInput" value='<?php echo $interaction; ?>' placeholder="Resource Person/Judge">
                        </div>
                        <div class="form-group">
                            <label for="interactionyear">SELECT YEAR</label>
                            <select class="form-control" value='' name="interaction-year" id="interactionyear">
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" name="interaction-modify" class="btn btn-secondary">UPDATE</button>
    ...
    if (isset($_GET['interaction-modify'])) {
        $Sr = $_GET['interaction-rollno'];
        $interaction = $_GET['interaction'];
        $Year = $_GET['interaction-year'];

        $update = "UPDATE interaction SET Interaction = '$interaction',Year = '$Year' WHERE Sr = '$Sr'";
