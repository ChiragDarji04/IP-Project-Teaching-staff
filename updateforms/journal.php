                ...
                <div id="" class="container ">
                    ...
                    <form id="form2" method="GET" action="journal.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="journal-rollno" class="form-control" value='<?php echo $rollno; ?>'>
                            <input type="text" name="journal-title" class="form-control" id="formGroupjournalInput" value='<?php echo $title; ?>' placeholder="Enter Journal Title">
                        </div>
                        <div class="form-group">
                            <label for="formGroupjournalInput2">NAME OF THE JOURNAL</label>
                            <input type="text" name="journal" class="form-control" id="formGroupjournalInput2" value='<?php echo $journal; ?>' placeholder="Enter Name Of The Journal">
                        </div>
                        <div class="form-group">
                            <label for="formGroupjournalInput3">PAGES</label>
                            <input type="text" name="journal-pages" class="form-control" id="formGroupjournalInput3" value='<?php echo $page; ?>' placeholder="Vol , Page No">
                        </div>
                        <div class="form-group">
                            <label for="formGroupjournalInput4">Journal with Impact FACTOR</label>
                            <input type="text" name="journal-factor" class="form-control" id="formGroupjournalInput4" value='<?php echo $factor; ?>' placeholder="Journal With Impact FACTOR">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="journal-upload" type="text" class="form-control" id="formGroupjournalInput6" value='<?php echo $view; ?>' placeholder="Enter Journal Link" required> <br>
