                ...
                <div id="" class="container ">
                    ...
                    <form id="form7" method="GET" action="nptel.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="nptel-rollno" class="form-control" value='<?php echo $rollno; ?>'>
                            <input type="text" name="nptel-name" id="nptelname" class="form-control" value='<?php echo $name; ?>' placeholder="Enter Course Name">
                        </div>
                        <div class="form-group">
                            <label for="nptelduration">DURATION</label>
                            <input type="text" name="nptel-duration" id="nptelduration" class="form-control" value='<?php echo $duration; ?>' placeholder="Enter Duration">
                        </div>
                        <div class="form-group">
