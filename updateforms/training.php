                ...
                <div id="" class="container ">
                    ...
                    <form id="form5" method="GET" action="training.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="training-rollno" class="form-control" value='<?php echo $rollno; ?>'>
                            <input type="text" name="training" class="form-control" id="formGrouptrainingInput" value='<?php echo $training; ?>' placeholder="Enter Training">
                        </div>
                        <div class="form-group">
                            <label for="formGrouptrainingInput2">TITLE</label>
                            <input type="text" name="training-title" class="form-control" id="formGrouptrainingInput2" value='<?php echo $title; ?>' placeholder="Enter Training Title">
                        </div>
                        <div class="form-group">
                            <label for="formGrouptrainingInput3">NAME OF THE PROGRAM</label>
                            <input type="text" name="training-program" class="form-control" id="formGrouptrainingInput3" value='<?php echo $program; ?>' placeholder="Enter Training Program">
                        </div>
                        <div class="form-group">
                            <label for="formGrouptrainingInput4">ORGANIZING AGENCY</label>
                            <input type="text" name="training-agency" class="form-control" id="formGrouptrainingInput4" value='<?php echo $agency; ?>' placeholder="Enter Organizing Agency">
                        </div>
                        <div class="form-group">
